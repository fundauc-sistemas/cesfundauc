...
**
** Created: Thu 18. Sep 11:03:58 2014
...
"color: rgb(00,56,147);"));
    ...
    void retranslateUi(QWidget *precios)
    {
        ...
        ___qtablewidgetitem2->setText(QApplication::translate("precios", "Precio 40%", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem3 = tabla->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("precios", "Precio 20%", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem4 = tabla->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("precios", "Noct/Sab. 40%", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem5 = tabla->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("precios", "Noct/Sab 20%", 0, QApplication::UnicodeUTF8));
        QTableWidgetItem *___qtablewidgetitem6 = tabla->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("precios", "Base Descuento", 0, QApplication::UnicodeUTF8));
